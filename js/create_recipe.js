        ...
        const ingredient = `
            <li id="${ingredient_id}" class="ml-5">
                <div class="flex items-center">
                    <input type="text" placeholder="Ingrediens" class="px-3 py-1 rounded-xl w-full max-w-[300px] " minlength="5" maxlength="30">
    ...
    insertStep.addEventListener("click", function() {  
        ...
        const step = `
            <li id="${step_id}" class="ml-5">
                <div class="flex items-center">
                <textarea type="text" placeholder="Fremgangsmåde" class="px-3 py-1 rounded-xl w-full max-w-[450px] max-h-[100px] md:min-w-[300px]" minlength="5" maxlength="255"></textarea>
        ...
        `
        document.querySelector("#step_guide_ol").insertAdjacentHTML("afterbegin", step)
    })
